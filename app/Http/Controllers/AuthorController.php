...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        $table = Author::create([
            ...
            "place_of_bird" => $request->place_of_bird,
    ...
    public function update(Request $request, $id)
    {
        ...
        if($author){
            ...
            $author->date_of_bird = $request->date_of_bird ? $request->date_of_bird : $author->date_of_bird;
            $author->place_of_bird = $request->place_of_bird ? $request->place_of_bird : $author->place_of_bird;
